...
Este trabalho propõe o desenvovimento de uma adaptação do modelo de Inteligência artificial Detectron2, o ambiente utilizado foi o Colab, e os locais escolhidoa para sua aplicação é de salas da faculdade (sala de estudos, sala de projetos e salas de aula) para a função de detectar pessoas em salas da faculdade, retornando o número de pessoas na sala e os status dela, se a sala está ocupada ou vazia.
